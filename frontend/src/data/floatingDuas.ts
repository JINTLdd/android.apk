// 20 duas rotated every 2 hours
export const FLOATING_DUAS = [
  "لا إله إلا أنت سبحانك إني كنت من الظالمين",
  "ربِّ اغفر لي وتب عليَّ إنك أنت التواب الرحيم",
  ...
  "ربِّ إني مسَّني الضر وأنت أرحم الراحمين",
  "حسبي الله لا إله إلا هو عليه توكلت وهو رب العرش العظيم",
  "اللهم إني أعوذ بك من الهم والحزن والعجز والكسل",
  "اللهم ألِّف بين قلوبنا وأصلح ذات بيننا",
  "ربَّنا آتنا في الدنيا حسنة وفي الآخرة حسنة وقنا عذاب النار",
  "ربِّ زدني علماً وارزقني فهماً",
  "اللهم إني أسألك الهدى والتقى والعفاف والغنى",
  "ربَّنا لا تزغ قلوبنا بعد إذ هديتنا وهب لنا من لدنك رحمة",
...
// Animated Azan text shown during prayer popup
export const AZAN_TEXT_LINES = [
